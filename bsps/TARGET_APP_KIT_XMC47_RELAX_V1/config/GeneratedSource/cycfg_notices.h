...
#ifndef XMC4700_F144x2048
    #error "Unexpected MPN; expected DEVICE:=XMC4700-F144x2048. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
